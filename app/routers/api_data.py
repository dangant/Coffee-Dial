...
def import_all(file: UploadFile = File(...), db: Session = Depends(get_db)):
    ...
    for t in data.get("brew_templates", []):
        db.add(BrewTemplate(
            ...
            bloom_pour_time_seconds=t.get("bloom_pour_time_seconds"),
            first_pour_grams=t.get("first_pour_grams"),
            first_pour_time_seconds=t.get("first_pour_time_seconds"),
            second_pour_grams=t.get("second_pour_grams"),
            second_pour_time_seconds=t.get("second_pour_time_seconds"),
            final_pour_grams=t.get("final_pour_grams"),
            final_pour_time_seconds=t.get("final_pour_time_seconds"),
            pour_method=t.get("pour_method"),
            grind_suggestion_um=t.get("grind_suggestion_um"),
    ...
    for b in data.get("brews", []):
        db.add(Brew(
            ...
            grind_suggestion_um=b.get("grind_suggestion_um"),
            ...
            notes=b.get("notes"),
            brewed_for_friend=b.get("brewed_for_friend", False),
            is_first_brew=b.get("is_first_brew", False),
