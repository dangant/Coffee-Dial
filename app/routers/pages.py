...
def create_brew_form(
    ...
    bloom_pour_time_seconds: str = Form(""),
    first_pour_grams: str = Form(""),
    first_pour_time_seconds: str = Form(""),
    second_pour_grams: str = Form(""),
    second_pour_time_seconds: str = Form(""),
    final_pour_grams: str = Form(""),
    final_pour_time_seconds: str = Form(""),
    pour_method: str = Form(""),
...
def create_template_form(
    ...
    bean_origin: str = Form(""),
    bean_process: str = Form(""),
    bean_variety: str = Form(""),
    drying_method: str = Form(""),
    harvest_season: str = Form(""),
    production_roaster: str = Form(""),
    preferred_extraction: str = Form(""),
    caffeine_mg: str = Form(""),
    coffee_summary: str = Form(""),
    roast_date: str = Form(""),
    roast_level: str = Form(""),
    flavor_notes_expected: list[str] = Form([]),
    ...
    data = TemplateCreate(
        ...
        bean_origin=bean_origin or None,
        bean_process=bean_process or None,
        bean_variety=bean_variety or None,
        drying_method=drying_method or None,
        harvest_season=harvest_season or None,
        production_roaster=production_roaster or None,
        preferred_extraction=preferred_extraction or None,
        caffeine_mg=caffeine_mg or None,
        coffee_summary=coffee_summary or None,
        roast_date=date.fromisoformat(roast_date) if roast_date else None,
        roast_level=roast_level or None,
        flavor_notes_expected=notes_str,
        ...
        grind_setting=grind_setting or None,
        grinder=grinder or None,
        # Bloom is derived: set iff any bloom field was recorded
        bloom=bool(bloom_water_ml or bloom_time_seconds or bloom_pour_time_seconds) or None,
        bloom_time_seconds=_parse_time_seconds(bloom_time_seconds, "bloom duration"),
        bloom_water_ml=float(bloom_water_ml) if bloom_water_ml else None,
        bloom_pour_time_seconds=_parse_time_seconds(bloom_pour_time_seconds, "bloom pour time"),
        first_pour_grams=_parse_int(first_pour_grams, "first pour water"),
        ...
        final_pour_time_seconds=_parse_time_seconds(final_pour_time_seconds, "final pour time"),
        pour_method=pour_method or None,
        grind_suggestion_um=_parse_int(grind_suggestion_um, "grind suggestion (µm)"),
